...
const styles = {
  h2: "text-2xl lg:text-4xl font-black uppercase tracking-tighter mb-6 text-slate-950 dark:text-white",
  h3: "text-xl lg:text-2xl font-black uppercase tracking-tight mb-4 text-slate-950 dark:text-white",
  p: "text-slate-600 dark:text-slate-400 leading-relaxed font-medium",
  ul: "list-inside list-disc text-slate-600 dark:text-slate-400 leading-relaxed font-medium space-y-2",
  li: "list-item pl-2",
  // Altnernatively, you can use the library react-syntax-highlighter to display code snippets.
  code: "text-sm font-mono bg-slate-950 dark:bg-white text-white dark:text-black p-8 rounded-2xl my-8 overflow-x-auto select-all shadow-xl",
  codeInline:
    "text-sm font-mono bg-slate-100 dark:bg-white/10 px-1.5 py-0.5 rounded-md select-all font-bold",
};
...
export const articles = [
  {
    ...
    content: (
      <>
        <div className="relative group overflow-hidden rounded-[2rem] mb-12 shadow-2xl">
          <Image
            src={introducingSupabaseImg}
            alt="Supabase and ShipFast logo combined"
            width={700}
        ...
        <section className="space-y-6 mt-16">
          ...
          <p className={styles.p}>
            First, go to{" "}
            <a href="https://supabase.com/" className="text-primary hover:underline underline-offset-4 decoration-primary/50 transition-all font-bold">
              Supabase
            </a>{" "}
